...
public class BeerServiceTest {
    ...
    void whenValidBeerNameIsGivenThenReturnABeer() throws BeerNotFoundException {
        ...
        Beer FoundBeer = beerMapper.toModel(FoundBeerDTO);

        // when
        when(beerRepository.findByName(FoundBeer.getName())).thenReturn(Optional.of(FoundBeer));

        // then
        BeerDTO foundBeerDTO = beerService.findByName(FoundBeerDTO.getName());

        assertThat(foundBeerDTO, is(equalTo(FoundBeerDTO)));
    }
    ...
    void whenListBeerIsCalledThenReturnAListOfBeers() {
        ...
        assertThat(foundListBeersDTO.get(0), is(equalTo(FoundBeerDTO)));
    }
    ...
    void whenExclusionIsCalledWithValidIdThenABeerShouldBeDeleted() throws BeerNotFoundException{
        // given
        BeerDTO DeletedBeerDTO = BeerDTOBuilder.builder().build().toBeerDTO();
        Beer DeletedBeer = beerMapper.toModel(DeletedBeerDTO);
        // when
        when(beerRepository.findById(DeletedBeerDTO.getId())).thenReturn(Optional.of(DeletedBeer));
        doNothing().when(beerRepository).deleteById(DeletedBeerDTO.getId());
        // then
        beerService.deleteById(DeletedBeerDTO.getId());
        verify(beerRepository, times(1)).findById(DeletedBeerDTO.getId());
        verify(beerRepository, times(1)).deleteById(DeletedBeerDTO.getId());
    }
    ...
    void whenIncrementIsCalledThenIncrementBeerStock() throws BeerNotFoundException, BeerStockExceededException {
        ...
        assertThat(expectedQuantityAfterIncrement, lessThan(BeerDTO.getMax()));
    }
